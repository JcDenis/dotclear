...
class Combo
{
    ...
    {
        return array_flip(App::core()->blog()->posts()->getPostsStatusNames());
    }
    ...
    {
        $status_combo = [];
        foreach (App::core()->blogs()->getBlogsStatusNames() as $k => $v) {
    ...
    {
        return array_flip(App::core()->blog()->comments()->getCommentsStatusNames());
    }
