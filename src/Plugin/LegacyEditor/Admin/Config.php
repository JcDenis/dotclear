...
class Config extends ModuleConfig
{
    ...
    {
        App::core()->blog()->settings('LegacyEditor')->putSetting('active', !empty($post['LegacyEditor_active']), 'boolean');
    ...
    public function getConfiguration(): void
    {
        ...
        Form::checkbox('LegacyEditor_active', 1, (bool) App::core()->blog()->settings('LegacyEditor')->getSetting('active')) .
