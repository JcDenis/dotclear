...
class Spamfilters
{
    ...
    {
        if (true === $global) {
            App::core()->blog()->settings('antispam')->dropSetting('antispam_filters');
        }
        App::core()->blog()->settings('antispam')->putSetting('antispam_filters', $opts, 'array', 'Antispam Filters', true, $global);
    }

    private function setFilterOpts(): void
    {
        if (null !== App::core()->blog()->settings('antispam')->getSetting('antispam_filters')) {
            $this->filters_opt = App::core()->blog()->settings('antispam')->getSetting('antispam_filters');
        }
