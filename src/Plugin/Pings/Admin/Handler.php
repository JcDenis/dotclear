...
class Handler extends AbstractPage
{
    ...
    protected function getPagePrepend(): ?bool
    {
        try {
            ...
            $this->pings_uris = App::core()->blog()->settings('pings')->getGlobalSetting('pings_uris');
            if (!$this->pings_uris) {
                $this->pings_uris = [];
            }
            ...
            if (GPC::post()->isset('pings_srv_name')) {
                ...
                App::core()->blog()->settings('pings')->putSetting('pings_active', !GPC::post()->empty('pings_active'), null, null, true, true);
                App::core()->blog()->settings('pings')->putSetting('pings_uris', $this->pings_uris, null, null, true, true);
                // Settings for current blog only
                App::core()->blog()->settings('pings')->putSetting('pings_auto', !GPC::post()->empty('pings_auto'), null, null, true, false);
    ...
    protected function getPageContent(): void
    {
        ...
        '<p><label for="pings_active" class="classic">' . Form::checkbox('pings_active', 1, App::core()->blog()->settings('pings')->getSetting('pings_active')) .
        ...
        '<p><label for="pings_auto" class="classic">' . Form::checkbox('pings_auto', 1, App::core()->blog()->settings('pings')->getSetting('pings_auto')) .
