...
class RsExtComment extends RsExtend
{
    ...
    {
        if (empty($format)) {
            $format = App::core()->blog()->settings('system')->getSetting('date_format');
        }
    ...
    {
        if (empty($format)) {
            $format = App::core()->blog()->settings('system')->getSetting('time_format');
        }
    ...
    public function getContent(bool $absolute_urls = false): string
    {
        ...
        $res = App::core()->blog()->settings('system')->getSetting('comments_nofollow') ?
    ...
    public function getAuthorLink(): string
    {
        ...
        $rel = 'ugc';
        if (App::core()->blog()->settings('system')->getSetting('comments_nofollow')) {
            $rel .= ' nofollow';
        }
