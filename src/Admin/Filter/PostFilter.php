...
class PostFilter extends Filter
{
    ...
    public function __construct(string $type = 'posts', string $post_type = '')
    {
        ...
        core()->behaviors->call('adminPostFilter', $filters);
    ...
    public function getPostUserFilter(): ?DefaultFilter
    {
        ...
        $combo = core()->combos->getUsersCombo($users);
    ...
    public function getPostStatusFilter(): DefaultFilter
    {
        return (new DefaultFilter('status'))
            ...
            ->options(array_merge(
                ['-' => ''],
                core()->combos->getPostStatusesCombo()
            ))
            ->prime(true);
    }
    ...
    public function getPostMonthFilter(): ?DefaultFilter
    {
        ...
        return (new DefaultFilter('month'))
            ...
            ->options(array_merge(
                ['-' => ''],
                core()->combos->getDatesCombo($dates)
            ));
    }
    ...
    public function getPostLangFilter(): ?DefaultFilter
    {
        ...
        return (new DefaultFilter('lang'))
            ...
            ->options(array_merge(
                ['-' => ''],
                core()->combos->getLangsCombo($langs, false)
            ));
    }
