<?php
/**
 * @class Dotclear\Admin\Page\Catalog\Catalog\PostCatalog
...
namespace Dotclear\Admin\Page\Catalog\Catalog;
    ...
    public function display($page, $nb_per_page, $enclose_block = '', $filter = false)
    {
        if ($this->rs->isEmpty()) {
            ...
            if ($filter) {
                ...
                $nb_published   = (int) dotclear()->blog()->posts()->getPosts(['post_status' => 1], true)->f(0);
                $nb_pending     = (int) dotclear()->blog()->posts()->getPosts(['post_status' => -2], true)->f(0);
                $nb_programmed  = (int) dotclear()->blog()->posts()->getPosts(['post_status' => -1], true)->f(0);
                $nb_unpublished = (int) dotclear()->blog()->posts()->getPosts(['post_status' => 0], true)->f(0);
                $html_block .= '<caption>' .
