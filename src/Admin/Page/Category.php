...
class Category extends Page
{
    public function __construct(Core $core)
    {
        ...
        $blog_settings = new Settings($core, $core->blog->id);
        ...
        if ($cat_id && isset($_POST['cat_parent'])) {
            ...
            if ($cat_parent != $new_parent) {
                try {
                    ...
                    static::addSuccessNotice(__('The category has been successfully moved'));
        ...
        if (!empty($_GET['upd'])) {
            static::success(__('Category has been successfully updated.'));
        }
