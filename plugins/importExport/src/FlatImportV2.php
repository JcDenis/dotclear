...
class FlatImportV2 extends FlatBackup
{
    ...
    public function __construct($file)
    {
        ...
        dcCore::app()->behavior->call('importInitV2', $this);
    }
    ...
    public function importSingle()
    {
        ...
        try {
            ...
            while (($line = $this->getLine()) !== false) {
                ...
                dcCore::app()->behavior->call('importSingleV2', $line, $this);
            }
    ...
    public function importFull()
    {
        ...
        try {
            while (($line = $this->getLine()) !== false) {
                ...
                dcCore::app()->behavior->call('importFullV2', $line, $this);
            }
        } catch (Exception $e) {
            @fclose($this->fp);
            $this->con->rollback();
        ...
        if (!$this->userExists($user_id)) {
            if (dcCore::app()->auth->isSuperAdmin()) {
                ...
                if (!$this->userExists($user_id)) {
                    ...
                    dcCore::app()->users->add($this->cur_user);
    ...
    private function prepareDC12line(&$line)
    {
        ...
        dcCore::app()->behavior->call('importPrepareDC12V2', $line, $this);
    }
}
