...
class FrontendTemplate
{
    ...
    public static function displayBreadcrumb(string $separator = ''): string
    {
        ...
        if (dcCore::app()->behavior->call('publicBreadcrumbExtended', dcCore::app()->url->type)) {
            # --BEHAVIOR-- publicBreadcrumb -- string, string
            $special = dcCore::app()->behavior->call('publicBreadcrumb', dcCore::app()->url->type, $separator);
