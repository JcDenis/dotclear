...
class FrontendUrl extends dcUrlHandlers
{
    ...
    public static function pages(?string $args): void
    {
        if ($args == '') {
            ...
            dcCore::app()->behavior->call('publicPagesBeforeGetPosts', $params, $args);
            ...
            if (dcCore::app()->ctx->posts->isEmpty()) {
                ...
                $default_template = Path::real(dcCore::app()->plugins->getDefine('pages')->root) . DIRECTORY_SEPARATOR . dcPublic::TPL_ROOT . DIRECTORY_SEPARATOR;
