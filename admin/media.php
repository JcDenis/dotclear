        ...
        if (dcCore::app()->admin->page->select) {
            ...
            if (dcCore::app()->admin->page->post_id) {
                ...
                '<div class="form-note info"><p>' . sprintf(
                    ...
                    '<a href="' . dcCore::app()->post_type->backend(dcCore::app()->admin->page->getPostType(), dcCore::app()->admin->page->post_id) . '">' . Html::escapeHTML(dcCore::app()->admin->page->getPostTitle()) . '</a>',
